        ...
        <div className="order">
            <div className="main">
                ...
                <div className="btns">
                    <button type="button" onClick={() => setExtended(extended ? false : true)}>
                        ...
                        {extended ? <IoCaretUp className="fs-17" /> : <IoCaretDown className="fs-17" />}
                    </button>
            ...
            {extended && (
                <div className="extended">
                            ...
                            <table className="simple">
                                <tbody>
                                    <tr className="d-sm-none">
                                        <td>Общая сумма:</td>
                                        <td>
                                            <span className="fs-12 fw-7">{props.priceSum} ₽</span>
                                        </td>
                                    </tr>
                                    <tr className="d-sm-none">
                                        <td>Статус заказа:</td>
                    ...
                    <p className="mt-4">
                        <span className="main-color fw-6">Комментарий к заказу:</span> {props.comment}
                    </p>
                </div>
            )}
        </div>
