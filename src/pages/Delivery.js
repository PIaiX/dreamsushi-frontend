...
import {ReactComponent as IconDelivery} from '../assets/imgs/delivery.svg'
import {ReactComponent as IconPickup} from '../assets/imgs/picking-up.svg'
import {ReactComponent as IconOnline} from '../assets/imgs/online.svg'
import {ReactComponent as IconCard} from '../assets/imgs/card.svg'
import {ReactComponent as IconCash} from '../assets/imgs/cash.svg'
        ...
        <main>
            <Container className='delivery'>
                <section className='mb-6'>
                    ...
                    <Row>
                        <Col md={9} lg={7}>
                            <p className='font-faded mb-4'>Закажите доставку в самый отдалённый уголок и мы привезём Ваш заказ без опозданий.</p>
                            <p className='font-faded mb-4'>Бесплатная доставка при заказе от 700 ₽ в черте города.</p>
                            <p className='font-faded mb-4'>Среднее время доставки 1ч — 1ч 20м.</p>
                            <p className='font-faded mb-4'>Время доставки может меняться в зависимости от количества заказов.</p>
                        ...
                        <Col md={6} lg={4}>
                            <div className='d-flex align-items-start'>
                                ...
                                <div className='flex-1 ms-3 ms-sm-4'>
                                    ...
                                    <p className='font-faded'>Курьер привезёт с собой мобильный платёжный терминал. Принимаются карты Mastercard, Maestro и Visa.</p>
                                </div>
                            </div>
                        </Col>
                        <Col md={6} lg={4}>
                            <div className='d-flex align-items-start'>
                                ...
                                <div className='flex-1 ms-3 ms-sm-4'>
                                    ...
                                    <p className='font-faded'>Вы можете оплатить заказ наличными нашему курьеру или при самовывозе</p>
                                </div>
                            </div>
                        </Col>
                    </Row>
