        ...
        <main>
            <Container>
                <section className="about mb-6">
                        ...
                        <Col>
                            <div className="d-flex">
                                ...
                                <div className="flex-1">
                                    <p className="fs-12 mb-3 mb-lg-4">
                                        улица Гагарина, 93 <br />
                                    ...
                                    <div>
                                        <a className="fs-12 fw-7" href="tel:+79061145814">
                                            +7 906 114-58-14
                                        </a>
                                    </div>
                                </div>
                    ...
                    <iframe
                        title="map"
                        src="https://yandex.ru/map-widget/v1/?um=constructor%3A7a0a0d8272fe1cc3e5f1dc0d85c1527ad62fac23a41e932974f23a0ba6e6000d&amp;source=constructor"
                        width="100%"
                        height="400"
                        frameBorder="0"
                    />
                    ...
                    <Row className="justify-content-around mt-5">
                                ...
                                <li className="d-flex mb-4 mb-sm-5">
                                    ...
                                    <div className="flex-1 ms-3 ms-sm-4">
                                        ...
                                        <p className="font-faded mt-2 mt-sm-3">
                                            В DreamSushi каждый ролл приготовлен с заботой о ваших
                                            гастрономических предпочтениях
                                        </p>
                                    </div>
                                </li>
                                <li className="d-flex mb-4 mb-sm-5">
                                    ...
                                    <div className="flex-1 ms-3 ms-sm-4">
                                        ...
                                        <p className="font-faded mt-2 mt-sm-3">
                                            Используем только охлаждённый, а не замороженный лосось.
                                            Так мы сохраняем максимум полезных свойств и ярких вкусовых качеств
                                        </p>
                                    </div>
                                </li>
                                <li className="d-flex mb-4 mb-sm-5">
                        ...
                        <Col xs={12} md={6} lg={5} xxl={4}>
                            <h3 className="fw-6 mb-4">
                                <span className="main-color">Dream Sushi</span> - мечтай, заказывай, воплощай!
                            </h3>
                            <div className="text">
                                <p>
                                ...
                                <p>
                                    Ощутить всю полноту вкусов наших роллов вы сможете только заказав
                                    из основного меню.
                                </p>
                                <p>
                                ...
                                <p>
                                    <a href="tel:+78432406727">+7 843 240-67-27</a>;
                                </p>
                                <p>
                                    <a href="tel:+79061145814">+7 (906) 114–58–14</a>.
                                </p>
                                <p>
                                    Нет времени ждать? Приезжайте и забирайте ваш заказ с Гагарина
                                    93 либо Фучика 88А
                                </p>
                                <p>
                                    Здесь вас всегда встретит дружелюбный персонал, ответит на все вопросы,
                                    а также с радостью поможет с выбором
                                </p>
