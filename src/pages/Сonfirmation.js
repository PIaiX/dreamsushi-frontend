                ...
                <section className='mb-6'>
                    <Row className='justify-content-between'>
                        <Col xs={12} lg={5} xxl={4} className='mb-5 md-lg-0'>
                            <h1><IoCheckmarkCircle className='green fs-07'/> Заказ принят!</h1>
                        ...
                        <Col xs={12} lg={7}>
                            <div className='box'>
                                <div className='d-flex align-items-baseline'>
                                    <h3><span className='main-color me-2'>•</span> Состав заказа</h3>
                                    <div className='ms-4'>4 позиции</div>
                                </div>
                                <hr/>
                                <div>
                                    <ProductItem title={'Пицца Итальяно'} imgLink={'imgs/products/prod10.jpg'} ingredients={'Бекон, Куринные бёдрышки, Томаты черри, Грибы шампиньоны, Соус пэсто, Сыр Моцарелла, Сыр Чеддер'} price={900} discount={0.25} count={3}/>
                                    <ProductItem title={'Пицца Итальяно'} imgLink={'imgs/products/prod10.jpg'} ingredients={'Бекон, Куринные бёдрышки, Томаты черри, Грибы шампиньоны, Соус пэсто, Сыр Моцарелла, Сыр Чеддер'} price={900} discount={0.25} count={3}/>
                                    <ProductItem title={'Пицца Итальяно'} imgLink={'imgs/products/prod10.jpg'} ingredients={'Бекон, Куринные бёдрышки, Томаты черри, Грибы шампиньоны, Соус пэсто, Сыр Моцарелла, Сыр Чеддер'} price={900} discount={0.25} count={3}/>
                                </div>
                            </div>
