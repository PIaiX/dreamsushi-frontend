                            ...
                            <div className='h-100 d-flex flex-column justify-content-between'>
                                ...
                                <div className='mt-4 d-flex flex-column flex-lg-row-reverse justify-content-end align-lg-items-center'>
                                    <div className='d-flex align-items-center ms-lg-5'>
                                        <span className='fs-15 fw-6 me-4'>{(count === 0) ? weight : weight*count} г</span>
                                        {
                                            (discount !== null)
                                            ? <>
                                                <span className='main-color fs-15 fw-6'>{(count === 0) ? price*(1-discount) : price*(1-discount)*count} ₽</span>
                                                <del className='light-gray fw-6 ms-3'>{(count === 0) ? price : price*count} ₽</del>
                                            </>
                                    ...
                                    <form className='btns'>
                                        <button type='button' className='edge me-2 me-sm-3' onClick={()=>handleMinus()}><FiMinus/></button>
                                        <button type='button' className='center' onClick={() => setCount((count===0)?1:count)}>
                                            {
                                                (count===0)
                                                ? 'Выбрать'
                                                : count
                                        ...
                                        <button type='button' className='edge ms-2 ms-sm-3' onClick={()=>handlePlus()}><FiPlus/></button>
                                    </form>
                                </div>
                            </div>
                        </Col>
