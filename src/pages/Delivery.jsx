                ...
                <section className="mb-6">
                    ...
                    <Row>
                        <Col md={9} lg={7}>
                            ...
                            <p className="font-faded mb-2">Московский - от 1200₽ бесплатная доставка,</p>
                            <p className="font-faded mb-2">Ново-Савиновский - от 1200₽ бесплатная доставка,</p>
                            <p className="font-faded mb-2">
                                Авиастроительный - от 1200₽ бесплатная доставка до определенных границ - далее платная
                                доставка,
                            </p>
                            <p className="font-faded mb-2">
                                Кировский - от 1200₽ бесплатная доставка до определенных границ - далее платная
                                доставка от 300₽,
                            </p>
                            <p className="font-faded mb-2">
                                Советский - от 1200₽ бесплатная доставка до определенных границ - далее платная
                                доставка от 100₽,
                            </p>
                            <p className="font-faded mb-2">
                                Приволжский - от 1200₽ бесплатная доставка до определенных границ - далее платная
                                доставка от 100₽,
                            </p>
                            <p className="font-faded mb-2">
